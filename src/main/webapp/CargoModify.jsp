...
<div class="layout">
    <div><br><br><br><br></div>
    <h1 class="pageHead">港口货物管理系统><span class="subPageHead">修改货物信息</span></h1>
    <div class="adCargoForm">
        <form action="/PortCargoSystem_war_exploded/CargoUpdateServlet?uid=${user.id}" method="post" name="addCargoForm" onsubmit="return validateform()">
            ...
            <div class="form-group">
                <label>货物名称:</label>
                <input type="text" class="form-control"  id="name" name="name" value="${cargo.name}" placeholder="请输入货物名称">
            </div>
            <div class="form-group">
                <label>货物重量(单位:t):</label>
                <input type="text" class="form-control"  id="weight" name="weight" value="${cargo.weight}" placeholder="请输入货物重量(单位:t)">
            </div>
            <div class="form-group">
                <label>货物种类:</label>
            ...
            <div class="form-group">
                <label>入库时间:</label>
                <input type="date" class="form-control"  id="intime" name="intime" value="${cargo.intime}" placeholder="请选择入库时间">
            </div>
            <div class="form-group">
                <label>货物状态:</label>
